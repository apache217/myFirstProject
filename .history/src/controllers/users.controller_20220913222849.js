...
class UserController {
  ...
  getByGender(req, res) {
    ...
    //   for (let i = 0; i < req.users.length; i++) {
    //     if (req.users.i.isMan === gend) gendArr.push(req.users.i);
    //   }
    //   return res.starus(200).send(gendArr);
    // } else return res.status(400).send(`Gender is not defined!`);
    let i = 0;
    return res.send(req.users.i.isMan)
  }
}
